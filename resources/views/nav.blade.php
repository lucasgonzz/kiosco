<nav class="navbar navbar-expand-lg">
	...
	<div class="menu d-none d-lg-block" id="navbarNav">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link {{ active('resumen-ventas-hoy') }} {{ active('resumen-ventas-desde-una-fecha') }}" href="{{ route('resumen-ventas-hoy') }}"><i class="fas fa-key m-r-5 fa-xs"></i>Resumen de ventas</a>
			</li>
			<li class="nav-item">
